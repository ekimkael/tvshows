	...
	return (
		<>
			...
			<div className="col-md-8 mx-auto py-5">
				...
				<p>
					<span className="highlight preview_company_name">Company Name</span>{" "}
					is permitted to revise these Terms at any time as it sees fit, and by
				...
				<p>
					...
					<span className="highlight preview_country">Country</span>, and you
					submit to the non-exclusive jurisdiction of the state and federal
					courts located in{" "}
					<span className="highlight preview_country">Country</span> for the
